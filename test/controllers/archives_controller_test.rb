...
class ArchivesControllerTest < ActionController::TestCase
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post :create, archive: { animateur: @archive.animateur, date_dif: @archive.date_dif, description: @archive.description, duration: @archive.duration, guest: @archive.guest, title: @archive.title }
    end
  ...
  test "should update archive" do
    patch :update, id: @archive, archive: { animateur: @archive.animateur, date_dif: @archive.date_dif, description: @archive.description, duration: @archive.duration, guest: @archive.guest, title: @archive.title }
    assert_redirected_to archive_path(assigns(:archive))
  end
