...
class ActualitesControllerTest < ActionController::TestCase
  ...
  test "should create actualite" do
    assert_difference('Actualite.count') do
      post :create, actualite: { contenu: @actualite.contenu, date: @actualite.date, lieu: @actualite.lieu, sous_titre: @actualite.sous_titre, titre: @actualite.titre }
    end
  ...
  test "should update actualite" do
    patch :update, id: @actualite, actualite: { contenu: @actualite.contenu, date: @actualite.date, lieu: @actualite.lieu, sous_titre: @actualite.sous_titre, titre: @actualite.titre }
    assert_redirected_to actualite_path(assigns(:actualite))
  end
